...
const int EIGEN_ORIENTATION_METHOD_NONE = 0;
const int EIGEN_ORIENTATION_METHOD_X_AXIS = 1;
const int EIGEN_ORIENTATION_METHOD_Y_AXIS = 2;
const int EIGEN_ORIENTATION_METHOD_Z_AXIS = 3;
const int EIGEN_ORIENTATION_METHOD_LOCAL = 4;

const int LIGHT_INTEGRATOR_LINE = 0;
const int LIGHT_INTEGRATOR_RK4 = 1;
const int LIGHT_INTEGRATOR_EXPLICIT = 2;
...
const int SHADING_MODE_STREAMLINES_COST = 9;

const int SHADING_MODE_FTLE_SURFACE_TYPE = 0;
const int SHADING_MODE_FTLE_SURFACE_FTLE_VALUE = 1;
const int SHADING_MODE_FTLE_SURFACE_STRENGTH = 2;

const int VOLUME_RENDERING_MODE_ORIGINAL_FTLE = 0;
const int VOLUME_RENDERING_MODE_RIDGES = 1;
const int VOLUME_RENDERING_MODE_SMALLEST_EIGENVALUE = 2;
