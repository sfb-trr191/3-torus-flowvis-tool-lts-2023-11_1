...
class UIMultiSeed {
    constructor(ui_seeds, index) {
        ...
        this.className_node_row_radius = "horizontal_div_multi_seed_vec3";     
        this.node_row_radius = document.createElement("div");
        this.node_row_radius.className = this.className_node_row_radius;        
        this.node_vertical.appendChild(this.node_row_radius);        
        ...
        this.className_node_row_vector = "horizontal_div_multi_seed_vec3";    
        this.node_row_vector = document.createElement("div");
        this.node_row_vector.className = this.className_node_row_vector;        
        this.node_vertical.appendChild(this.node_row_vector);

        this.className_node_row_vector2 = "horizontal_div_multi_seed_vec3";    
        this.node_row_vector2 = document.createElement("div");
        this.node_row_vector2.className = this.className_node_row_vector2;        
        this.node_vertical.appendChild(this.node_row_vector2);
        ...
        this.node_option_circle = document.createElement("option");
        this.node_option_circle.value = MULTI_SEED_MODE_CIRCLE;
        this.node_option_circle.innerText = "Circle";
        this.node_input_select.appendChild(this.node_option_circle);
        ...
        this.node_row_radius_label = document.createElement("label");
        this.node_row_radius_label.innerHTML = "radius";
        this.node_row_radius.appendChild(this.node_row_radius_label);

        this.node_input_radius = document.createElement("input");
        this.node_input_radius.type = "text";
        this.node_input_radius.value = "0.05";
        this.node_input_radius.title = "The raidus of the circle.";
        this.node_row_radius.appendChild(this.node_input_radius);
        ...
        this.node_row_vector_label = document.createElement("label");
        this.node_row_vector_label.innerHTML = "vector";
        this.node_row_vector.appendChild(this.node_row_vector_label);

        this.node_input_vector_x = document.createElement("input");
        this.node_input_vector_x.type = "text";
        this.node_input_vector_x.value = "0";
        this.node_input_vector_x.title = "x component of the vector.";
        this.node_row_vector.appendChild(this.node_input_vector_x);

        this.node_input_vector_y = document.createElement("input");
        this.node_input_vector_y.type = "text";
        this.node_input_vector_y.value = "1";
        this.node_input_vector_y.title = "y component of the vector";
        this.node_row_vector.appendChild(this.node_input_vector_y);

        this.node_input_vector_z = document.createElement("input");
        this.node_input_vector_z.type = "text";
        this.node_input_vector_z.value = "0";
        this.node_input_vector_z.title = "z component of the vector";
        this.node_row_vector.appendChild(this.node_input_vector_z);

        //ROW VECTOR 2

        this.node_row_vector2_label = document.createElement("label");
        this.node_row_vector2_label.innerHTML = "vector";
        this.node_row_vector2.appendChild(this.node_row_vector2_label);

        this.node_input_vector2_x = document.createElement("input");
        this.node_input_vector2_x.type = "text";
        this.node_input_vector2_x.value = "0";
        this.node_input_vector2_x.title = "x component of the vector.";
        this.node_row_vector2.appendChild(this.node_input_vector2_x);

        this.node_input_vector2_y = document.createElement("input");
        this.node_input_vector2_y.type = "text";
        this.node_input_vector2_y.value = "0";
        this.node_input_vector2_y.title = "y component of the vector";
        this.node_row_vector2.appendChild(this.node_input_vector2_y);

        this.node_input_vector2_z = document.createElement("input");
        this.node_input_vector2_z.type = "text";
        this.node_input_vector2_z.value = "1";
        this.node_input_vector2_z.title = "z component of the vector";
        this.node_row_vector2.appendChild(this.node_input_vector2_z);
    ...
    toString() {
        ...
        switch(mode){
            ...
            case MULTI_SEED_MODE_ALIGNED_PLANE_GRID:
                ...
                //TODO
                return s;
            case MULTI_SEED_MODE_CIRCLE:
                var s = this.node_input_select.value + "~"
                + this.node_input_count.value + "~"
                + this.node_row_radius.value + "~"                
                + this.node_input_x.value + "~"
                + this.node_input_y.value + "~"
                + this.node_input_z.value + "~"
                + this.node_input_vector_x.value + "~"
                + this.node_input_vector_y.value + "~"
                + this.node_input_vector_z.value + "~"
                + this.node_input_vector2_x.value + "~"
                + this.node_input_vector2_y.value + "~"
                + this.node_input_vector2_z.value + "~"
                + this.node_input_c1.value + "~"
                + this.node_input_c2.value;
                return s;
            default:
    ...
    fromString(s) {
        ...
        switch(mode){
            ...
            case MULTI_SEED_MODE_ALIGNED_PLANE_GRID:
                ...
                break;
            case MULTI_SEED_MODE_CIRCLE:
                this.node_row_radius.value = split[2];
                this.node_input_x.value = split[3];
                this.node_input_y.value = split[4];
                this.node_input_z.value = split[5];
                this.node_input_vector_x.value = split[6];
                this.node_input_vector_y.value = split[7];
                this.node_input_vector_z.value = split[8];
                this.node_input_vector2_x.value = split[9];
                this.node_input_vector2_y.value = split[10];
                this.node_input_vector2_z.value = split[11];
                this.node_input_c1.value = split[12];
                this.node_input_c2.value = split[13];
            default:
                break;
        }
        this.OnChangedMode();
    ...
    OnChangedMode(){
        ...
        switch(mode){
            case MULTI_SEED_MODE_RANDOM:
                ...
                this.node_row_random_number.className = this.className_node_row_random_number;
                this.node_row_radius.className = "hidden";
                this.node_row_point.className = "hidden";
                this.node_row_point2.className = "hidden";
                this.node_row_vector.className = "hidden";
                this.node_row_vector2.className = "hidden";
        ...
        for (var j = 0; j < count; j++){
            ...
            switch(mode){
                ...
                case MULTI_SEED_MODE_ALIGNED_PLANE_RANDOM:
                    ...
                    break;
                case MULTI_SEED_MODE_CIRCLE:
                    var radius = parseFloat(multi_seed.node_input_radius.value);
                    var x1 = parseFloat(multi_seed.node_input_x.value);
                    var y1 = parseFloat(multi_seed.node_input_y.value);
                    var z1 = parseFloat(multi_seed.node_input_z.value);
                    var vec1_x = parseFloat(multi_seed.node_input_vector_x.value);
                    var vec1_y = parseFloat(multi_seed.node_input_vector_y.value);
                    var vec1_z = parseFloat(multi_seed.node_input_vector_z.value);
                    var vec2_x = parseFloat(multi_seed.node_input_vector2_x.value);
                    var vec2_y = parseFloat(multi_seed.node_input_vector2_y.value);
                    var vec2_z = parseFloat(multi_seed.node_input_vector2_z.value);
                    var v_position = glMatrix.vec3.fromValues(x1, y1, z1);
                    var v_vec1 = glMatrix.vec3.fromValues(vec1_x, vec1_y, vec1_z);
                    var v_vec2 = glMatrix.vec3.fromValues(vec2_x, vec2_y, vec2_z);
                    var v_result = glMatrix.vec3.create();
                    
                    var t = j / (count);
                    var radian = t * 2 * Math.PI;

                    var x = radius * Math.cos(radian);
                    var y = radius * Math.sin(radian);

                    glMatrix.vec3.scaleAndAdd(v_result, v_position, v_vec1, x);
                    glMatrix.vec3.scaleAndAdd(v_result, v_result, v_vec2, y);

                    var result_x = v_result[0];
                    var result_y = v_result[1];
                    var result_z = v_result[2];

                    phantom_seed.node_input_x.value = result_x.toFixed(FIXED_LENGTH_RANDOM_SEED_POSITION);
                    phantom_seed.node_input_y.value = result_y.toFixed(FIXED_LENGTH_RANDOM_SEED_POSITION);
                    phantom_seed.node_input_z.value = result_z.toFixed(FIXED_LENGTH_RANDOM_SEED_POSITION);
