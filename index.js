...
; (function () {
    ...
    */
    ...
    function UpdateRenderSettings() {
        ...
        canvas_wrapper_main.volume_rendering_directions = tree_view.IsVisibleInHierarchy(2) ? parseInt(document.getElementById("select_show_volume_main").value) : VOLUME_RENDERING_DIRECTIONS_NONE;
        ...
        canvas_wrapper_side.volume_rendering_directions = tree_view.IsVisibleInHierarchy(10) ? parseInt(document.getElementById("select_show_volume_side").value) : VOLUME_RENDERING_DIRECTIONS_NONE;
